...
def make_cli():
    ...
    cli.add_argument("--input-bed", type=str, required=True, help="Path to BED file.")
    cli.add_argument("--seed", type=int, default=1749789967685151308)
    cli.add_argument("--samples-per-chrom", type=int, default=25)
