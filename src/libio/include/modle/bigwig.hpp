...
[[nodiscard]] inline bigWigFile_t* init_bigwig_file(
    std::string_view output_path, std::vector<std::pair<std::string, I>>& chromosomes,
    int32_t zoom_levels = 10, std::size_t buff_size = DEFAULT_BUFF_SIZE);

[[nodiscard]] inline bigWigFile_t* init_bigwig_file(std::string_view output_path,
