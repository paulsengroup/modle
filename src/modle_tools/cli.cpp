...
void Cli::make_eval_subcommand() {
  auto* sc =
      this->_cli
          .add_subcommand(
              "evaluate",
              "Compare Model's output with other contact matrices using various correlation tests.")
          ->fallthrough();
  sc->alias("eval");
  ...
  sc->add_option(
      "--tmp-dir",
      this->_config.tmp_dir,
      "Path where to store temporary files.")
      ->capture_default_str();

  sc->add_flag(
      "--keep-temporary-files",
      this->_config.keep_tmp_files,
  ...
  sc->add_flag(
      "--eucl-dist",
      this->_config.compute_edist,
      "Compute Euclidean distance.");

  sc->add_flag(
      "--pearson",
      this->_config.compute_pearson,
      "Compute Pearson correlation.");

  sc->add_flag(
      "--spearman",
      this->_config.compute_spearman,
  ...
  sc->add_option(
      "--sliding-window-size",
      this->_config.sliding_window_size,
  ...
  sc->add_option(
      ...
      this->_config.sliding_window_overlap,
  ...
  sc->add_flag(
      ...
      this->_config.deplete_contacts_from_reference,
...
void Cli::make_filter_barriers_subcommand() {
  ...
  sc->add_option(
      ...
      this->_config.path_to_extrusion_barrier_motifs_bed,
  ...
  sc->add_option(
      "bedFiles",
      this->_config.path_to_bed_files_for_filtering,
  ...
  sc->add_option(
      ...
      this->_config.filtering_criterion,
  ...
  sc->add_flag(
      ...
      this->_config.strict_bed_validation,
...
void Cli::make_noisify_subcommand() {
  auto* sc =
      this->_cli.add_subcommand("noisify", "Add noise to ModLE's contact matrix in Cooler format.")
          ->fallthrough();
  ...
  sc->add_option(
      "-o,--output-name",
      this->_config.path_to_output_matrix,
...
void Cli::post_process_cli_args() {
