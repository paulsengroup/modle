    ...
    for (auto& chrom : this->_genome) {
      ...
      do {
        ...
        for (const auto& deletion : deletions) {
          ...
          t.reference_contacts = std::make_shared<const ContactMatrix<>>(
              read_reference_contacts(reference_cooler, chrom_name, t.window_start, t.window_end,
                                      this->bin_size, this->diagonal_width));
